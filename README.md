Project 4: Smart Feedback Router
...
Conditional Routing: Uses n8n IF Nodes and JavaScript to send urgent tickets to priority Slack channels.

Automated Response: Triggers a personalized "Thank You" or "Acknowledgment" email based on feedback type.
